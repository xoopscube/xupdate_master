...
/**
 * Xupdatemaster_AbstractListAction
**/
abstract class Xupdatemaster_AbstractListAction extends Xupdatemaster_AbstractAction
{
	public /*** XoopsSimpleObject[] ***/ $mObjects = null;

	public /*** Xupdatemaster_AbstractFilterForm ***/ $mFilter = null;
	 ...
	 * @param	void
	 * 
	 * @return	Xupdatemaster_{Tablename}FilterForm
	**/
