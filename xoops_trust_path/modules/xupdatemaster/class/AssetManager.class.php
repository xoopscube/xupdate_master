...
/**
 * Xupdatemaster_AssetManager
**/
class Xupdatemaster_AssetManager
{
    public /*** string ***/ $mDirname = '';

    public /*** string ***/ $mTrustDirname = 'xupdatemaster';
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Xupdatemaster_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Xupdatemaster_AssetManager[]
        **/
    ...
    **/
    ...
    {
        return XUPDATEMASTER_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
