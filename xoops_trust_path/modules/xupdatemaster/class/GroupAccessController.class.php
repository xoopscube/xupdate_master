...
require_once XUPDATEMASTER_TRUST_PATH . '/class/AbstractAccessController.class.php';

/**
 * Xupdatemaster_GroupAccessController
**/
class Xupdatemaster_GroupAccessController extends Xupdatemaster_AbstractAccessController
{
	public $mType = 'group';
