...
/**
 * Xupdatemaster_AbstractEditAction
**/
abstract class Xupdatemaster_AbstractEditAction extends Xupdatemaster_AbstractAction
{
    ...
    **/
    public function getDefaultView()
    {
        ...
        return XUPDATEMASTER_FRAME_VIEW_INPUT;
    }
    ...
    **/
    public function execute()
    {
        ...
        {
            return XUPDATEMASTER_FRAME_VIEW_CANCEL;
        }
    ...
    **/
    ...
    {
        $this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME')), 1, _MD_XUPDATEMASTER_ERROR_DBUPDATE_FAILED);
    }
